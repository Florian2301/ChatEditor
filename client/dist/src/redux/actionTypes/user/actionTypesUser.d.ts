...
export declare type Action = Clear | Welcome | Cancel | Logout | SetKeyL | SetKeyR | ChangeModus | SelectLanguage | WriteComment | AddUser | GetUser | GetAllUsers | DeleteUser | UpdateUser;
export {};
