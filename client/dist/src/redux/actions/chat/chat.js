import { ActionType } from '../../actionTypes/chat/actionTypesChat';
import axios from 'axios';
// save as chat
export const saveChat = (userId, user, chatnumber, title, author, date, language, tags, description, philosopher, messages, admin, comments) => (dispatch) => {
    axios
        .post('/api/chats', {
        userId,
        user,
...
// update chat details
export const updateChatDetails = (id, chatnumber, title, author, date, language, tags, description, admin, comments) => (dispatch) => {
    axios
        .patch(`/api/chats/${id}`, {
        admin,
        chatnumber,
