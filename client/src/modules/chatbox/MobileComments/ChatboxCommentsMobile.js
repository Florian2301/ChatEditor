...
const ChatboxComments = () => {
    ...
    //---- return ---------------------------------------------------------------------------------------------------
    return (React.createElement(Panel, { title: title, id: "chatbox-mobile" },
        React.createElement(Container, { className: user.writeComment ? 'commentchatbox-mobile' : 'chatbox-mobile' },
            ...
            }))) : (React.createElement("div", { className: "comments-info-mobile" }, "~ chose a chat and write a comment ~")),
...
//# sourceMappingURL=ChatboxCommentsMobile.js.map